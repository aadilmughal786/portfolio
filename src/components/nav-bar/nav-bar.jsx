...
const NavBar = () => {
  ...
  return (
    <div className="supports-backdrop-blur:bg-white/50 sticky top-0 z-40 flex w-full flex-col gap-4 border-b-2 border-slate-900/10 bg-white/50 py-3 backdrop-blur dark:border-slate-50/[0.06] dark:bg-transparent">
      <div
